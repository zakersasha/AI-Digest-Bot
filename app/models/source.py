...
class Source(Base):
    ...
    catalog_channel_id: Mapped[int | None] = mapped_column(
        ForeignKey("catalog_channels.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
    telegram_peer_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
