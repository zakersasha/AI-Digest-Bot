...
class User(Base):
    ...
    yandex_tokens_encrypted: Mapped[str | None] = mapped_column(nullable=True)
    yandex_email: Mapped[str | None] = mapped_column(String(255), nullable=True)
    yandex_linked_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
