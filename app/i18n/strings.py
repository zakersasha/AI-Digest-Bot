STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "digest_progress_read_gmail": "📥 Читаю письма Gmail <b>{label}</b>{dots}",
        "digest_progress_fetch_yandex": "📡 Загружаю Яндекс Почту <b>{label}</b>{dots}",
        "digest_progress_read_yandex": "📥 Читаю письма Яндекс <b>{label}</b>{dots}",
    ...
    "en": {
        ...
        "digest_progress_read_gmail": "📥 Reading Gmail emails <b>{label}</b>{dots}",
        "digest_progress_fetch_yandex": "📡 Loading Yandex Mail <b>{label}</b>{dots}",
        "digest_progress_read_yandex": "📥 Reading Yandex emails <b>{label}</b>{dots}",
